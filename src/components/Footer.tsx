        ...
        <div className="grid grid-cols-1 md:grid-cols-4 gap-8">
          ...
          <div>
            ...
            <ul className="space-y-2">
              <li>
                <Link to="/solutions/platinum" className="text-white/80 hover:text-primary transition-colors">
                  Platinum Platform
                </Link>
              </li>
              <li>
                <Link to="/solutions/ruby" className="text-white/80 hover:text-primary transition-colors">
                  Ruby Desktop
                </Link>
              </li>
              <li>
                <Link to="/solutions/services" className="text-white/80 hover:text-primary transition-colors">
          ...
          <div>
            ...
            <div className="space-y-3">
              <div className="flex gap-2">
                ...
                <span className="text-white/80">London, UK</span>
              </div>
              <div className="flex gap-2">
                <MapPin size={20} className="flex-shrink-0 text-primary" />
                <span className="text-white/80">Bristol, UK</span>
              </div>
            </div>
          </div>
        </div>
